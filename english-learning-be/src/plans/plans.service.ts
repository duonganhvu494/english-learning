...
export class PlansService {
  ...
  async getDefaultPlan(): Promise<Plan> {
    return this.getPlanByCodeOrThrow(
  ...
  async getActivePriceOrThrow(
    ...
    const plan =
      await this.getPlanByCodeOrThrow(planCode);
