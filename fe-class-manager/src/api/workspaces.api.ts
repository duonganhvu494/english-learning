...
export const workspacesApi = {
  async createWorkspace(payload: CreateWorkspaceDto): Promise<WorkspaceResponse> {
  ...
  async getPlans(): Promise<PlanResponse[]> {
    return unwrap<PlanResponse[]>(http.get('/workspaces/plans'));
  },

  async listWorkspaceStudents(workspaceId: string): Promise<WorkspaceStudentListItem[]> {
